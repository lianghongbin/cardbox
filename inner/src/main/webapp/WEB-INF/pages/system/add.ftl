        ...
        <div class="result-content">
            ...
            <table class="insert-tab" width="100%">
                ...
                <tr>
                    <th>android下载地址：</th>
                    <td>
                        <input class="common-text required" id="android" name="android" size="50" type="text"/>
                    </td>
                </tr>
                <tr>
                    <th>iOS下载ID</th>
                    <td>
                        <input class="common-text required" id="ios" value="100" name="ios" size="50" type="text"/>
                    </td>
                </tr>
                <tr>
                    <th>H5条数：</th>
                    <td><input type="text" name="h5" id="h5"></td>
                </tr>
                <tr>
                    <th>启动公告：</th>
